      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Let's discuss opportunities in data science and machine learning
          </p>
        </div>
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:saket.mishra_cs22@gla.ac.in" className="text-white hover:text-blue-400 transition-colors">
                      saket.mishra_cs22@gla.ac.in
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+91639831045" className="text-white hover:text-green-400 transition-colors">
                      +91 639 831 045
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white">Sahaswaan, U.P. (India)</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-2xl p-8 border border-white/10">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                machine learning projects, or research collaborations. Whether you have 
        ...
        <div className="mt-16 pt-8 border-t border-white/10 text-center">
          <p className="text-gray-400">
            © 2024 Saket Mishra. Built with passion for data science and machine learning.
          </p>
        </div>
      </div>
    </section>
